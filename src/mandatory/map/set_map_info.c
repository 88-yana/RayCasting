...
// /*   Updated: 2023/03/26 14:36:14 by hyanagim         ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// // 	{
// // 		if (ft_strcmp(dict->key[i], "NO"))
// // 			game->map_info.path.north = dict->value[i];
// // 		else if (ft_strcmp(dict->key[i], "SO"))
// // 			game->map_info.path.south = dict->value[i];
// // 		else if (ft_strcmp(dict->key[i], "WE"))
// // 			game->map_info.path.west = dict->value[i];
// // 		else if (ft_strcmp(dict->key[i], "EA"))
